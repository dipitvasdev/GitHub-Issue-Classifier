    ...
    useEffect(() => {
        ...
        if (closeButton) {
          closeButton.addEventListener('click', () => {
            const banner = document.querySelector(closeButton.getAttribute('data-dismiss-target') as string);
            if (banner) {
  ...
  return (
    ...
    <div className="flex items-center mx-auto">
        <p className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
            ...
            <span>Due to limited Databricks resources, the model now runs on PythonAnywhere with consistent functionality.</span>
        </p>
    </div>
